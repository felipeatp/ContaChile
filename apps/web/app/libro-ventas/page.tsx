          ...
          <>
            <section>
              ...
              <div className="grid gap-4 md:grid-cols-3">
                ...
                <Stat label="IVA (19 %)" value={formatCLP(data.summary.tax)} tone="default" />
                <Stat label="Total ventas" value={formatCLP(data.summary.total)} tone="accent" />
              </div>
            </section>
